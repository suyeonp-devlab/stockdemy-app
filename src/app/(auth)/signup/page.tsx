    ...
    <div className="w-full max-w-sm md:max-w-4xl md:grid md:grid-cols-2 md:gap-16 md:items-center">
      ...
      <div className="hidden md:block">
        <h1 className="text-5xl font-black text-gray-100 leading-tight mb-4">
          <span className="block opacity-0 animate-fadein" style={{ animationDelay: "0s" }}>지금 바로</span>
          <span className="block opacity-0 animate-fadein" style={{ animationDelay: "0.3s" }}>시작해보세요.</span>
        </h1>
